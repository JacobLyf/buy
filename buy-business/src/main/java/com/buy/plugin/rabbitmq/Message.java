...
import com.buy.plugin.rabbitmq.publisher.DeliveryOptions;
...
public class Message {
     ...
     * @throws IOException
     */
    public void publish(Channel channel,Map<String, Object> args) throws IOException{
        publish(channel, DeliveryOptions.NONE,args);
    }
     ...
     * @throws IOException
     */
    public void publish(Channel channel, DeliveryOptions deliveryOptions,Map<String, Object> args) throws IOException {
...
//                new Object[] { exchange, routingKey, deliveryOptions, basicProperties.getDeliveryMode() == 2 });
        ...
        /*if(queue.equalsIgnoreCase(RabbitMQConstants.PRODUCT_QUEUE)) {*/
          if(args==null){
        	  args = new HashMap<String, Object>();
          }
          if(queue.equalsIgnoreCase(RabbitMQConstants.PRODUCT_QUEUE)||queue.equalsIgnoreCase(RabbitMQConstants.SHOP_QUEUE)) {
        ...
        LOGGER.info("Successfully published message to exchange '{}' with routing key '{}', content '{}'", exchange, routingKey, new String(bodyContent));
    }
