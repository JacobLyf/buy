...
import com.buy.plugin.rabbitmq.ConnectionListener;
import com.buy.plugin.rabbitmq.SingleConnectionFactory;
...
public class ConsumerContainer {
    ...
    protected class ContainerConnectionListener implements ConnectionListener {
        ...
        @Override
        public void onConnectionEstablished(Connection connection) throws TimeoutException {
